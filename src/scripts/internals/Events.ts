...
export class EventManager {
    ...
    public static init (scene: Phaser.Scene): void
    {
        ...
        .on('bass', ()=>{
            ...
            EventManager.scene.scene.launch('BassUI', EventManager.scene);
            EventManager.scene.scene.pause('Controller');
            EventManager.scene.scene.setVisible(false, 'Controller');
        })

        .on('sampler', ()=>{

            EventManager.scene.scene.launch('SamplerUI', EventManager.scene);
            EventManager.scene.scene.pause('Controller');
            EventManager.scene.scene.setVisible(false, 'Controller');
        })
        ...
        .on('game', (level: string) => {  
            ...
            {
                return[
                    System.Process.app.audio.play('bloop1', 1, false, EventManager.scene, 0), 
